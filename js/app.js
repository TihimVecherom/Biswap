(() => {
    ...
    const menuBody = document.querySelector(".menu__body-wrap");
    ...
    const menuBodyFooter = document.querySelector(".menu__body-wrap-footer");
    const menuButtonFooter = document.querySelector(".menu__button-footer");
    if (menuButtonFooter) menuButtonFooter.addEventListener("click", (function(e) {
